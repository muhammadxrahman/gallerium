...
describe("buildSearchIndex", () => {
  ...
  it("includes Sun, Moon, the 5 planets, named stars and constellations", () => {
...
describe("targetAltAz / targetSelection / targetLabel", () => {
  const sky = computeBodies([star(7, 100, 20, "Vega")], NYC, DATE);
  ...
  it("returns null for a planet/star not present", () => {
