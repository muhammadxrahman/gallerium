...
const PATHS: Record<string, string> = {
  ...
  // Shooting star: a bright head with trailing streaks.
  meteor: `<circle cx="17" cy="7" r="2"/><line x1="14.5" y1="9.5" x2="4" y2="20"/><line x1="18" y1="12" x2="13" y2="17"/><line x1="12" y1="6" x2="7" y2="11"/>`,
  ...
  // Image / picture frame.
  image: `<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="8.5" cy="10" r="1.5"/><polyline points="21 16 15 11 5 19"/>`,
  // Reset / fit: arrows contracting toward the center.
  reset: `<polyline points="9 4 4 4 4 9"/><polyline points="15 4 20 4 20 9"/><polyline points="20 15 20 20 15 20"/><polyline points="9 20 4 20 4 15"/><circle cx="12" cy="12" r="1.4"/>`,
